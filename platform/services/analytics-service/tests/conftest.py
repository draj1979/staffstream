import pytest
from analytics_service import db
from analytics_service.db import get_db
...
async def session_factory(monkeypatch):
    ...
    # ingestion.py imports SessionFactory by reference at import time, so it
    # needs its own patch target too.
    import analytics_service.ingestion as ingestion_module
